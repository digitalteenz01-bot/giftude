        ...
        <div className="relative grid gap-10 lg:grid-cols-12 lg:items-center">
          <div className="lg:col-span-7">
            ...
            <div className="mt-10 flex flex-wrap items-center gap-5">
              ...
              >
                Start a quotation
                <span className="grid h-7 w-7 place-items-center rounded-full bg-navy text-gold transition-transform group-hover:rotate-45">↗</span>
              </Link>
              <Link to="/products" className="text-sm text-ivory/80 underline-offset-4 hover:underline">
          ...
          <div className="lg:col-span-5">
            <div className="relative mx-auto aspect-square w-full max-w-md overflow-hidden rounded-[2rem] animate-float">
              <img src={cta} alt="Single navy gift box with gold ribbon" loading="lazy" className="h-full w-full object-cover" />
            </div>
          </div>
        </div>
      </div>
