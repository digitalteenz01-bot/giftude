...
type Cat = { title: string; desc: string; img: string; alt: string; span: string };

const cats: Cat[] = [
  {
    title: "Premium Gift Sets",
    desc: "Curated boxes built around a single object of joy.",
    img: gifts,
  ...
  {
    title: "Lamps",
    desc: "Sculpture, warmth, presence.",
    img: lamps,
  ...
  {
    title: "Accessories",
    desc: "The small things gifted with intention.",
    img: accessories,
            ...
            >
              ...
              <div className="relative flex h-full min-h-[230px] flex-col justify-end p-6 text-ivory">
                ...
                <div className="mt-5 flex items-center gap-3">
                  ...
                  <span className="grid h-8 w-8 place-items-center rounded-full bg-gold text-navy transition-transform group-hover:rotate-45">
                    →
                  </span>
                </div>
              </div>
