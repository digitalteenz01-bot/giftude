...
import { t as Route } from "./contact-Cx197AO_.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/contact-DpSJXEBr.js
...
function ContactForm({ productSlug }) {
	...
	function onSubmit(e) {
		...
		window.open(`https://wa.me/78080255492?text=${encodeURIComponent(text)}`, "_blank", "noopener,noreferrer");
		setSent(true);
	}
